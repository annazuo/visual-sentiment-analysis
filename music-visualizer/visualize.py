...
#set output name
out_dir = os.path.join('../sentiment-analysis/videos/', args.mood)
if not os.path.exists(out_dir):
    os.makedirs(out_dir)

out_filename = f'{args.mood}_{args.pitch_sensitivity}_{int(args.tempo_sensitivity * 100)}.mp4'
outname = os.path.join('../sentiment-analysis/videos/', args.mood, out_filename)
